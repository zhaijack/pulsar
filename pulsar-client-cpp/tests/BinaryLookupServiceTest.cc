...
TEST(BinaryLookupServiceTest, basicGetNamespaceTopics) {
    ...
    std::string topicName1 = "persistent://prop/unit/ns/basicGetNamespaceTopics1";
    std::string topicName2 = "persistent://prop/unit/ns/basicGetNamespaceTopics2";
    std::string topicName3 = "persistent://prop/unit/ns/basicGetNamespaceTopics3";
    ...
    std::string url1 = adminUrl + "admin/persistent/prop/unit/ns/basicGetNamespaceTopics1/partitions";
    std::string url2 = adminUrl + "admin/persistent/prop/unit/ns/basicGetNamespaceTopics2/partitions";
    std::string url3 = adminUrl + "admin/persistent/prop/unit/ns/basicGetNamespaceTopics3/partitions";
