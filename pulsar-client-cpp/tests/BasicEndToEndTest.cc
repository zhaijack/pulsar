...
TEST(BasicEndToEndTest, testPatternTopicsConsumerInvalid) {
    ...
    // invalid namespace
    std::string pattern = "invalidDomain://prop/unit/ns/patternMultiTopicsConsumer.*";
    ...
    pattern = "persistent://prop/unit/ns/patternMultiTopicsConsumer.*";
...
TEST(BasicEndToEndTest, testPatternMultiTopicsConsumerPubSub) {
    Client client(lookupUrl);
    std::string pattern = "persistent://prop/unit/ns/patternMultiTopicsConsumer.*";

    std::string subName = "testPatternMultiTopicsConsumer";
    std::string topicName1 = "persistent://prop/unit/ns/patternMultiTopicsConsumerPubSub1";
    std::string topicName2 = "persistent://prop/unit/ns/patternMultiTopicsConsumerPubSub2";
    std::string topicName3 = "persistent://prop/unit/ns/patternMultiTopicsConsumerPubSub3";
    // This will not match pattern
    std::string topicName4 = "persistent://prop/unit/ns/patternMultiTopicsNotMatchPubSub4";

    // call admin api to make topics partitioned
    std::string url1 =
        adminUrl + "admin/persistent/prop/unit/ns/patternMultiTopicsConsumerPubSub1/partitions";
    std::string url2 =
        adminUrl + "admin/persistent/prop/unit/ns/patternMultiTopicsConsumerPubSub2/partitions";
    std::string url3 =
        adminUrl + "admin/persistent/prop/unit/ns/patternMultiTopicsConsumerPubSub3/partitions";
    std::string url4 =
        adminUrl + "admin/persistent/prop/unit/ns/patternMultiTopicsNotMatchPubSub4/partitions";
